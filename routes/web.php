...
Route::get('/profile/{id}', [UserController::class, "get_user"]);
Route::get('/profile/update/{id}', [UserController::class, "update"]);
Route::post('/profile/update-profile/edit', [UserController::class, "editt"]);
Route::post('/profile/update-profile/edit/pass', [UserController::class, "edit_pass"]);