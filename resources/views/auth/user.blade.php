        ...
        <div class="container">
            <div class="row my-5">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-12 col-md-4 d-flex align-items-center justify-content-center gap-3">
                ...
                <div class="col-lg-5 col-sm-8 col-md-8">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-6 info-label">
                                ...
                                <div class="col-lg-9 col-md-6 col-sm-6 color-red infoo">
